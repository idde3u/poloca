    ...
    return(
        <div className={styles.container}>
            <div className={styles.filters}>
                <h3 className={styles.filters__name}>Фильтры вакансий</h3>
            ...
            <div className={styles.cards_list}>
                <input className={styles.search__input} type="text" placeholder="Поиск по названию вакансии" value={selectedFilters.search} onChange={(e) => handleFilterChange("search", e.target.value)}/>   
                {articlesList}
            </div>
